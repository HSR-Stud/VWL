...
Unbeschränkte Bedürfnisse vs. knappe Ressourcen.
\subsubsection{Opportunitätskosten \ho{Ho2 F4-6}}
  Kosten, die bei einer Entscheidung anfallen, dass die Vorteile einer
  Handlungsalternative nicht realisiert werden können.\\
  Beispiel: Weil wir studieren verdienen wir derzeit nichts/weniger. Das Geld
  das wir dadurch verlieren sind die Opportunitätskosten.\\
  Die Opportunitätskosten zeigen die Knappheit eines Gutes an.
\subsubsection{Zentrale Rolle der Preise in der Marktwirtschaft \ho{Ho2 F8-9}}
  ...
  ist das ein anzeichen für knappheit. Planwirtschaft zerstört das alles.
\begin{multicols}{2}
	\subsubsection{Mikroökonomisches Grundmodell \ho{Ho2 F10-12}}
	  \begin{tabular}{ll}
	    Gütermarkt & Preis - Menge\\
	...
	\subsubsection{Mindestpreis \ho{Ho2 F16-19}}
	  Auswirkungen wenn man einen Mindestpreis einführt:\\
	  ...
	  Bei Höchstpreisen geschieht das ganze analog. Man sollte also nicht mit
	  Mindest/Höchstpreisen in den Markt eingreifen (auch bei Löhnen!).
...
\subsubsection{Zölle \ho{Ho3 F15-17}}
\subsubsection{Regionale Integrationsräume \ho{Ho3 F22FF}}
\begin{multicols}{2}
\subsection{Monopolmacht und Wettbewerb \ho{Ho4}}
  Grenzkosten = Kosten für letztes produziertes Gut (zunehmend)\\
  Grenzertrag = Ertrag für letztes produziertes Gut (abnehmend)\\
  Bei einem Monopol sind die beiden gleich!
  
\subsubsection{Natürliche und nicht-natürliche Monopole \ho{Ho4 F19FF}}
  Ein typisches natürliches Monopol ist der Eisenbahnverkehr. Man kann nicht
  einer anderen Firma sagen sie soll ein zweites Gleis daneben bauen. Um das
  natürliche Monopol zu lockern kann man zum Beispiel die Schienen
  Verstaatlichen aber darauf Verkehr für mehrere Firmen zulassen (SBB, DB, SOB,
...
\subsubsection{Technisches Know How \ho{Ho6 F7}}
  ...
  der unbeschränkt verfügbar ist.
